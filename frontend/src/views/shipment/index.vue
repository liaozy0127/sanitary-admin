...
const handlePrint = async (row) => {
  try {
    ...
    // 可用高度: 110mm，page-body 宽度 = 241 - 5*2 - 2 - 10*2 = 209mm
    const MM_TO_PX = 3.7795
    const PAGE_HEIGHT_PX = Math.round(110 * MM_TO_PX)
  ...
  * { box-sizing: border-box; }
  ...
  .measure-wrap { position: absolute; top: -9999px; left: 0; width: ${PAGE_BODY_WIDTH_PX}px; visibility: hidden; }`
    ...
    const colWidths = ['5%','26%','10%','5%','11%','6%','8%','6%','7%','8%','8%']
...
<div class="measure-wrap" id="owrap">
  <table class="pt" style="width:100%">
    ...
    <thead>
      ...
      <tr><td colspan="11" class="info-cell" id="oh_info1">
        <div class="info-flex">
      ...
      <tr><td colspan="11" class="info-cell" id="oh_info2">
    ...
    <tbody><tr><td>&nbsp;</td>${'<td>&nbsp;</td>'.repeat(10)}</tr></tbody>
    <tfoot>
      <tr><td colspan="11" class="foot-remark" id="oh_remark">${remarkLines}</td></tr>
    </tfoot>
  </table>
