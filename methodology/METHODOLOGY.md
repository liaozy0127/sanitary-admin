...
主 Agent 询问：选择运行模式？
    ...
    └─[2] 人工审查模式 ─────────────────────────────────────────────────┐
                                                                       │
        主 Agent 逐阶段驱动，每个关键节点 ⏸ 暂停                        │
            │                                                          │
            ▼                                                          │
        Stage 1: 开发（Sub-Agent 执行）                                 │
            │ 完成                                                      │
            ▼                                                          │
        ⏸ 主 Agent 推送审查报告摘要给用户                               │
            │ 用户回复「通过」或「修改：xxx」                             │
            ▼                                                          │
        Stage 3: 测试（Sub-Agent 执行）                                 │
            │ 完成                                                      │
            ▼                                                          │
        ⏸ 主 Agent 推送测试报告摘要给用户                               │
            │ 用户回复「通过」或「修复」                                  │
            ▼                                                          │
        （如有问题：修复 → 再次审查/测试，循环直到通过）                   │
            │ 通过                                                      │
            ▼                                                          │
        ⏸ 主 Agent 确认部署信息（版本/环境）                            │
            │ 用户回复「部署」或「取消」                                  │
            ▼                                                          │
        Stage 5: 部署（Sub-Agent 执行）                                 │
            │ 完成                                                      │
            ▼                                                          │
        主 Agent 推送最终报告 ◄─────────────────────────────────────────┘
```
