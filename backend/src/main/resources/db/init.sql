...
CREATE TABLE IF NOT EXISTS `material` (
    ...
    `default_price` DECIMAL(10,2) DEFAULT 0 COMMENT '默认单价（价格记忆）',
...
CREATE TABLE IF NOT EXISTS `production_item` (
    ...
    `unwarehoused_qty` DECIMAL(12,2) DEFAULT 0 COMMENT '未入库数量',
    `outsource_price` DECIMAL(10,2) DEFAULT 0 COMMENT '委外单价',
    `plating_price` DECIMAL(10,2) DEFAULT 0 COMMENT '电镀单价',
